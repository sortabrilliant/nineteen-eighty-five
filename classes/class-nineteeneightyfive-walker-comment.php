 ...
 * @since 1.0.0
 */
class NineteenEightyFive_Walker_Comment extends Walker_Comment {
	...
	protected function html5_comment( $comment, $depth, $args ) {
		...
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '', $comment ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body message -left">
				<i class="comment-author vcard">
					<?php
